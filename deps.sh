...
if [ "$EUID" -eq 0 ]; then
    error "ERROR: Please don't run this as root."
fi
...
function install_deps() {
    ...
    install_arch() {
        ...
        then
            paru -Sy --noconfirm ${missing_deps[*]} hdiffpatch-bin
    ...
    case "${DISTRO_ID}" in
        ubuntu|debian)
            ...
            FFMPEG_URL="https://github.com/pugdev3/files/raw/refs/heads/main/ffmpeg4-v2.tar.gz"
            install_ubuntu
            ;;
        fedora)
            log "Fedora detected."
